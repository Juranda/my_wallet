...
class AtividadeAlunoView extends StatefulWidget {
  ...
  @override
  State<AtividadeAlunoView> createState() => _AtividadeAlunoViewState();
}

class _AtividadeAlunoViewState extends State<AtividadeAlunoView> {
