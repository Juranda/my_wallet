  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: (){
                ...
                {
                  adicionaAluno(AlunoProfile(alunos, alunos.length, removeAluno));
        ...
        Divider(),
        Text('Alunos Adicionados', style: TextStyle(fontSize: 20),),
        Container(
        height: 350,
        ...
        Expanded(
          child: Container(
            ...
            child: TextButton(onPressed: ()=>Navigator.pop(context),style: TextButton.styleFrom(
              backgroundColor: Theme.of(context).colorScheme.primary,
              foregroundColor: Theme.of(context).colorScheme.secondary), child: Text('Ok'))),
        )
      ],
    );
  }
